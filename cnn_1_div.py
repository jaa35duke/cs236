...
model = Sequential()
model.add(Conv1D(128, kernel_size=1, strides=1, activation='relu', input_shape=(X.shape[1], X.shape[2])))
...
# confusion matrix
y_dev_1 = y_dev.argmax(1)
pred_dev_1 = pred_dev.argmax(1)
print("Confusion matrix: ")
print(confusion_matrix(y_dev_1, pred_dev_1))
